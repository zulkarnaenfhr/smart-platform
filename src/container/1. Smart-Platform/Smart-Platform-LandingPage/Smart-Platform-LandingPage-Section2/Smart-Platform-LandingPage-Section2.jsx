            ...
            <div id="SPL-LandingPage-Section2">
                <div className="SPL-LandingPage-Section2-Container container">
                    ...
                    <div className="SPL-LandingPage-Section2-Card-Container row" data-aos="fade-up" data-aos-offset="200">
                        ...
                        <div className="col-4">
                            <Cardspllandingpage
                                logoImg={require("../../../../src/Smart-Platform/Landing Page/Section-1-Big-View.png")}
                                marginTopDesc={"38px"}
                                marginTop={"26px"}
                                marginLeft={"11px"}
                                width={"223px"}
                        ...
                        <div className="col-4">
                            <Cardspllandingpage
                                logoImg={require("../../../../src/Smart-Platform/Landing Page/Section-1-Picaso.png")}
                                marginTopDesc={"26px"}
                                marginTop={"27px"}
                                marginLeft={""}
                                width={"233px"}
                    ...
                    <div className="SPL-LandingPage-Section2-Card-Container row" data-aos="fade-up" data-aos-offset="200">
                        ...
                        <div className="col-4">
                            <Cardspllandingpage
                                logoImg={require("../../../../src/Smart-Platform/Landing Page/Section-1-Big-Box.png")}
                                marginTopDesc={"25px"}
                                marginTop={"43px"}
                                marginLeft={"42px"}
                                width={"144px"}
                        ...
                        <div className="col-4">
                            <Cardspllandingpage
                                logoImg={require("../../../../src/Smart-Platform/Landing Page/Section-1-SmartEye.png")}
                                marginTopDesc={"29px"}
                                marginTop={"43px"}
                                marginLeft={"31px"}
                                width={"px"}
